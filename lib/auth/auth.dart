...
import 'package:Rehla/route/route.dart';
import 'package:Rehla/screens/tours/home_screen.dart';
    ...
    if (email.isNotEmpty && password.isNotEmpty) {
      ...
      if (authCredential!.uid.isNotEmpty) {
        ...
        if (isAdmin) {
          ...
          Navigator.pushReplacementNamed(context, AdminNavigationBars.routeName);
        } else {
          if (authCredential.emailVerified) {
            Fluttertoast.showToast(msg: 'Login Successful');
            Navigator.pushReplacementNamed(context, NavigationBars.routeName);
          } else {
            Fluttertoast.showToast(
